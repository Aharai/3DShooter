...
namespace Geekbrains.Editor.Test
{
	...
	public class TestBehaviourEditor : UnityEditor.Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			testTarget.center = EditorGUILayout.Vector3Field("Координаты центра", testTarget.center);
			testTarget.size = EditorGUILayout.Vector3Field("Координаты диапазона", testTarget.size);
